...
async function storePage(req, res) {
    try {
        ...
        if (req.body.password === req.body.cpassword) {
            ...
            else res.render("admin/user/create", {
                title: `${process.env.SITE_NAME} - Admin Page`,
                currentUrl: '/admin',
                errorMessage: { password: "Invalid Password. Password Must Contains Atleast 1 Upper Case Charactor, 1 Lower Case Charactor, 1 Digit and Length Must be 8-100 Charactor " },
                data: data,
                departments: await getDepartment(),
                session: req.session
            })
